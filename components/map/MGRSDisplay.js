...
function MGRSDisplay({ fix }) {
    ...
    return (<div className="bg-m3-surface border border-m3-outline-variant shadow-panel-sm rounded-panel w-[232px] overflow-hidden text-m3-on-surface">
            ...
            <div className="px-[14px] pt-[12px] pb-[10px] border-b border-m3-outline-variant">
                ...
                <div className="font-mono font-bold text-base text-m3-on-surface tracking-[0.06em] transition-opacity duration-[180ms]" style={{ opacity: fading ? 0 : 1 }}>
                    {mgrsTxt}
                </div>
            </div>
            ...
            { label: "ALT", value: altTxt },
                        ...
                        <div className="font-mono text-[0.6rem] text-m3-on-surface transition-opacity duration-[180ms]" style={{ opacity: fading ? 0 : 1 }}>
                            {item.value}
                        </div>
                    </div>))}
            </div>
            ...
            <div className="px-[14px] py-[10px] flex justify-between border-b border-m3-outline-variant">
                <div>
                    ...
                    <div className="font-mono text-[0.62rem] text-m3-on-surface transition-opacity duration-[180ms]" style={{ opacity: fading ? 0 : 1 }}>
                        {accTxt}
                    </div>
                </div>
