...
function GlobeCanvas() {
    ...
    return (<div className="relative w-full h-full map-grid overflow-hidden" style={{ background: "#000" }}>
            ...
            height: "min(70vw, 70vh)",
                ...
                {[0.75, 0.5, 0.25].map((scale) => (<div key={scale} className="absolute rounded-full" style={{
            ...
            background: "rgba(255,255,255,0.04)",
                ...
                {[-30, -15, 15, 30].map((deg) => (<div key={deg} className="absolute" style={{
            ...
            {DATA_POINTS.map((pt) => (<div key={pt.id} className="absolute flex flex-col items-center" style={{ left: pt.x, top: pt.y, transform: "translate(-50%, -50%)" }}>
