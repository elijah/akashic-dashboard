...
exports.default = IntelDetailsSidebar;
...
function IntelDetailsSidebar({ intel, onClose }) {
    if (!intel)
        return null;
    ...
    return (<div className="bg-m3-surface border border-m3-outline-variant shadow-panel-sm rounded-panel flight-sidebar w-[340px] max-h-[88vh] overflow-y-auto text-m3-on-surface">
            ...
            <div className="p-3">
                <div className="relative mb-3 h-32 w-full rounded-[calc(1rem-0.5rem)] border border-white/10 bg-black overflow-hidden" style={{
            background: `
            ...
            backgroundColor: "#050505"
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center opacity-70">
                        {intel.type === "shooting" ? (<div className="flex items-center justify-center gap-4">
                            ...
                            </div>) : (<div className="flex items-center gap-4" style={{ color }}>
                                <div className="relative w-16 h-20 border border-current bg-current/5 flex flex-col p-1 gap-1">
                                    ...
                                    <div className="mt-auto w-full h-4 bg-current/20 flex items-end justify-between p-[1px]">
                                        {[...Array(6)].map((_, i) => (<div key={i} className="w-1 bg-current animate-pulse" style={{
                ...
                {intel.story && (<div className="mt-4 border-l-2 border-stone-500 bg-stone-900/40 p-2.5 text-xs text-stone-300 prose prose-invert prose-p:my-1 prose-a:text-cyan-400 hover:prose-a:text-cyan-300">
                        <react_markdown_1.default>{intel.story}</react_markdown_1.default>
                    </div>)}
