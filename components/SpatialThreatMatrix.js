...
exports.SpatialThreatMatrix = void 0;
const react_1 = require("react");
const SpatialThreatMatrix = ({ onClose }) => {
    const [warnings, setWarnings] = (0, react_1.useState)([]);
    const [loading, setLoading] = (0, react_1.useState)(true);
    const [view, setView] = (0, react_1.useState)("collisions");
    const [targetLat, setTargetLat] = (0, react_1.useState)("48.8566");
    const [targetLng, setTargetLng] = (0, react_1.useState)("2.3522");
    const [radius, setRadius] = (0, react_1.useState)("100");
    const [proxData, setProxData] = (0, react_1.useState)(null);
    const [proxLoading, setProxLoading] = (0, react_1.useState)(false);
    ...
    (0, react_1.useEffect)(() => { fetch_trajectories(); }, []);
      ...
      <div className="relative w-[90vw] max-w-[1200px] h-[85vh] bg-[#050505] border border-red-900/50 shadow-[0_0_80px_rgba(220,38,38,0.15)] flex flex-col pointer-events-auto font-mono text-stone-300 rounded-xl overflow-hidden">
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="flex-1 p-4 overflow-y-auto bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#110505] to-[#050505]">
            ...
            {view === "collisions" && (<div className="flex flex-col gap-4">
                ...
                {loading ? (<div className="w-full h-32 flex items-center justify-center">
                  ...
                  </div>) : warnings.length === 0 ? (<div className="w-full h-32 flex items-center justify-center">
                    <div className="text-xs font-bold text-green-500 uppercase tracking-widest">ZERO SPATIAL COLLISIONS DETECTED</div>
                  </div>) : (<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {warnings.map((w, i) => (<div key={i} className="bg-[#0a0a0a] border border-red-900/50 rounded-lg p-3 relative overflow-hidden group hover:border-red-500 transition-colors">
            ...
            {view === "proximity" && (<div className="flex flex-col gap-4">
                ...
                {proxData && (<div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex flex-col gap-2 overflow-y-auto max-h-[500px] pr-2 custom-scrollbar">
                        {proxData.events.map((e) => (<div key={e.id} className="bg-[#0a0a0a] border border-stone-800 p-2 rounded">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex flex-col gap-2 overflow-y-auto max-h-[500px] pr-2 custom-scrollbar">
                        {proxData.assets.map((a) => (<div key={a.id} className="bg-[#0a0a0a] border border-stone-800 p-2 rounded">
                            <div className="flex justify-between items-center mb-1">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex flex-col gap-2 overflow-y-auto max-h-[500px] pr-2 custom-scrollbar">
                        {proxData.flights.map((f) => (<div key={f.id} className="bg-[#0a0a0a] border border-stone-800 p-2 rounded">
                            <div className="flex justify-between items-center mb-1">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex flex-col gap-2 overflow-y-auto max-h-[500px] pr-2 custom-scrollbar">
                        {proxData.vessels.map((v) => (<div key={v.id} className="bg-[#0a0a0a] border border-stone-800 p-2 rounded">
                            <div className="flex justify-between items-center mb-1">
...
exports.SpatialThreatMatrix = SpatialThreatMatrix;
